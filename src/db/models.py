...
class User(Base):
    ...
    first_name = Column(
        String(255), nullable=True, info={"description": "First name of the user"}
    )
    last_name = Column(
        String(255), nullable=True, info={"description": "Last name of the user"}
    )
    email = Column(
        String(255),
        nullable=False,
    ...
    # Quan hệ nhiều-nhiều với bảng Character
    ...
    # Quan hệ một-nhiều với bảng HistoryLog
...
class HistoryLog(Base):
    ...
    # Quan hệ một-nhiều với bảng User và Character
    user = relationship(
        "User",
